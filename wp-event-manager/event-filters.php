		...
		<div class="wpem-row">
				...
				<div class="wpem-col">
					...
					<?php else : ?>
						<?php event_manager_dropdown_selection( array( 
								...
								'hierarchical' => 1,
								'show_option_all' => __( 'Choose a Country', 'wp-event-manager' ), 
			...
			<?php elseif ( $show_event_types && ! is_tax( 'event_listing_type' ) && get_terms( 'event_listing_type', ['hide_empty' => false] ) ) : ?>		
				<div class="wpem-col">
					...
					<?php else : ?>
						<?php event_manager_dropdown_selection( array( 'value'=>'slug', 'taxonomy' => 'event_listing_type', 'hierarchical' => 1, 'show_option_all' => __( 'Choose a Continent', 'wp-event-manager' ), 'name' => 'search_event_types', 'orderby' => 'name', 'selected' => $selected_event_type, 'multiple' => false,'hide_empty' => false) ); ?>
					<?php endif; ?>
					</div>
				</div>
			<?php endif; ?>		        
