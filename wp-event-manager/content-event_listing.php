            ...
            <a href="<?php display_event_permalink(); ?>" class="wpem-event-action-url event-style-color <?php echo $event_type; ?>">
                ...
                <div class="wpem-event-infomation">
                    ...
                    <div class="wpem-event-details">
                        ...
                        <?php if (get_the_term_list( $post->ID, 'state' )) : ?>
                            <div class="wpem-event-type"><?php echo get_the_term_list( $post->ID, 'state', '<span class="wpem-event-type-text event-type">', ', ', '</span>' ) ?></div>
                        <?php endif; ?>

                        <?php if (get_the_term_list( $post->ID, 'city' )) : ?>
                            <div class="wpem-event-type"><?php echo get_the_term_list( $post->ID, 'city', '<span class="wpem-event-type-text event-type">', ', ', '</span>' ) ?></div>
                        <?php endif; ?> 
                        
                        <?php if (get_event_url_meeting()): ?>
                            <div>
                               URL meeting <a href= "<?php display_event_url_meeting( $post); ?> "> &#x1F517;</a>  
                            </div>
                        <?php endif; ?> 
