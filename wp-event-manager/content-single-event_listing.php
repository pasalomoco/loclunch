                                            ...
                                            foreach ($additional_fields as $name => $field) : ?>
                                                ...
                                                <?php if( !empty($field_value) ) : ?>
                                                    ...
                                                    <?php else : ?>
                                                        ...
                                                        <?php else : ?>    
                                                            <?php if(is_array($additional_fields)) : ?>
                                                                            ...
                                                                            <div class="wpem-col-md-6 wpem-col-sm-12 wpem-additional-info-block-details-content-left">
                                                                                <div class="wpem-additional-info-block-details-content-items">
                                                                                    <p class="wpem-additional-info-block-title">
                                                                                        <strong style="font-size: x-large"><?php echo $field['label']; ?> &nbsp;</strong> 
                        ...
                        <div class="wpem-col-xs-12 wpem-col-sm-5 wpem-col-md-4 wpem-single-event-right-content">
                            <div class="wpem-single-event-body-sidebar">
                                ...
                                <div class="wpem-single-event-sidebar-info">
                                    ...
                                    <?php echo ucwords(get_the_author_meta('display_name', $event->post_author )); ?>

                                    <?php if (get_event_coambassadors()): ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpem-heading-text">
                                            Co-Ambassador/s
                                        </h3>
                                        <?php display_event_coambassadors( '', '', true, $post); ?>
                                    <?php endif; ?>   
                                    ...
                                    <?php if (get_option('event_manager_enable_event_types') && get_event_type()) : ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpem-heading-text"><?php _e('Continent', 'wp-event-manager'); ?></h3>
                                        <div class="wpem-event-type"><?php display_event_type(); ?></div>
                                    <?php endif; ?>

                                    <?php if (get_option('event_manager_enable_categories') && get_event_category()) : ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpem-heading-text"><?php _e('Country', 'wp-event-manager'); ?></h3>
                                        <div class="wpem-event-category"><?php display_event_category(); ?></div>
                                    <?php endif; ?>

                                    <?php if (get_the_term_list( $event->ID, 'state' )) : ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpem-heading-text"><?php _e('State', 'wp-event-manager'); ?></h3>
                                        <div class="wpem-event-category"><?php echo get_the_term_list( $post->ID, 'state', '<span class="wpem-event-category-text event-category">', ', ', '</span>' ) ?></div>
                                    <?php endif; ?>

                                    <?php if (get_the_term_list( $event->ID, 'city' )) : ?>
                                        <div class="clearfix">&nbsp;</div>
                                        <h3 class="wpem-heading-text"><?php _e('City', 'wp-event-manager'); ?></h3>
                                        <div class="wpem-event-category"><?php echo get_the_term_list( $post->ID, 'city', '<span class="wpem-event-category-text event-category">', ', ', '</span>' ) ?></div>
                                    <?php endif; ?>
