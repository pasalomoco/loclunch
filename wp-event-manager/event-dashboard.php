			...
			<?php else : ?>
				<div class="wpem-dashboard-main-header">
					...
					<div class="wpem-dashboard-main-title wpem-dashboard-main-filter">
						<h3 class="wpem-theme-text"><?php if( $events) echo count($events); ?> loclunch-events created</h3>

						<div class="wpem-d-inline-block wpem-dashboard-i-block-btn">

							<!--delete ical buttom <?php do_action('event_manager_event_dashboard_button_action_start'); ?> -->
							...
							<!--delete ical buttom <?php do_action('event_manager_event_dashboard_button_action_end'); ?> -->

							<a href="javascript:void(0)" title="<?php _e('Search Filter','wp-event-manager');?>" class="wpem-dashboard-event-filter wpem-dashboard-header-btn"><i class="wpem-icon-filter"></i></a>
						</div>
					</div>
								...
								<?php foreach ( $events as $event ) : ?>
									<div class="wpem-dashboard-event-list">
										...
										<div class="wpem-dashboard-event-datetime-location">
											...
											<?php $urlMeeting = get_post_meta($event->ID, "_url_meeting", true);
											    if( !empty($urlMeeting)) : ?>
												<div class="wpem-dashboard-event-url">
													<div class="wpem-dashboard-event-placeholder"><strong><?php _e('Url meeting', 'wp-event-manager') ?></strong></div>
													<?php _e($urlMeeting); ?>
												</div>
											<?php endif; ?>
